...
public class Config {
    ...
    public Config() {
        ...
        this.browserName = System.getProperty("browserName", CHROME);
        ...
        this.mobilePlatform = System.getProperty("mobilePlatform", "android");
        this.mobileVersion = System.getProperty("mobileVersion", "7.0");
